...
async function handleMessageRevocation(client, revocationMessage) {
  ...
  if (originalMessage) {
    ...
    let notificationText = `░𝙃𝙤𝙡𝙡𝙖...𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝘼𝙉𝙏𝙄𝘿𝙀𝙇𝙀𝙏𝙀░\n\n` +
...
client.sendMessage(m.chat, { image: { url: 'https://i.imgur.com/wZcGmu7.jpeg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
                            externalAdReply: {
                                ...
                                sourceUrl: 'https://wa.me/255747397675?text=Hello👋+black+Nihostie+Bot+Mkuu+😔',
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
                        }
...
//========================================================================================================================//	
case "pair": case "rent": {
if (!q) return await reply("𝐡𝐨𝐥𝐥𝐚 𝐩𝐥𝐞𝐚𝐬𝐞 𝐩𝐫𝐨𝐯𝐢𝐝𝐞 𝐚 𝐯𝐚𝐥𝐢𝐝 𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐧𝐮𝐦𝐛𝐞𝐫 𝐦𝐦𝐡... 𝐄𝐱𝐚𝐦𝐩𝐥𝐞- pair 2557473976XX");
        ...
        async function redeployApp() {
            try {
                const response = await axios.post(
                    ...
                    {
                        source_blob: {
                            url: "https://github.com/ZEZETECH47/zeze-md-bot/tarball/main",
                        },
                    },
                    {
                        headers: {
...
//========================================================================================================================//		      
     case "hidetag": case "tag": { 
             ...
             if (!isBotAdmin) throw botAdmin; 
             if (!isAdmin) throw admin; 
            client.sendMessage(m.chat, { text : q ? q : 'ZEZE 𝗕𝗹𝗶𝗻𝗱 𝗧𝗮𝗴𝘀😅' , mentions: participants.map(a => a.id)}, { quoted: m }); 
             } 
 break; 
                ...
                client.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: '𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃𝐁𝐎𝐓',
                            body: 'https://whatsapp.com/channel/0029VbANIT5D8SDpK7oExi1v',
...
//========================================================================================================================//		      
         ...
         for (let i of res) { 
             let txt = `𝐙𝐄𝐙𝐄𝟒𝟕-𝐌𝐃 𝐁𝐎𝗧 𝗕𝗥𝗢𝗔𝗗𝗖𝗔𝗦𝗧 >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}` 
...
try {
        ...
        pp = 'https://i.imgur.com/wZcGmu7.jpeg';
      }
